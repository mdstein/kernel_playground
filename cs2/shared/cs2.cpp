...
namespace cs2
{
	...
	namespace netvars
	{
		...
		static int m_entitySpottedState = 0; //m_entitySpottedState = 0x10F8;
...
BOOL cs2::player::has_bomb(QWORD player)
{
	return (BOOL)vm::read_i8(game_handle, player + netvars::m_);
}
